  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/modules/colaborador/pages/AdminColaboradoresPage.vue'),
        meta: { title: 'Admin - Colaboradores' }
      },
      {
        path: 'administradores',
        name: 'admin-administradores',
        component: () => import('@/modules/administradores/pages/AdminAdministradoresPage.vue'),
        meta: { title: 'Admin - Administradores' }
      },
      {
        path: 'auditoria',
        name: 'admin-auditoria',
        component: () => import('@/modules/sistema/pages/AdminAuditoriaPage.vue'),
