...
const saveMaterial = async () => {
  ...
  try {
    if (modalTab.value === 'existente') {
      ...
      await materialesService.ligarConvocatoria(selectedMaterialId.value, props.convocatoriaId)
    } else {
              ...
              <div v-if="modalTab === 'archivo'" class="pt-2">
                ...
                >
                  ...
                  <template v-if="!attachedFile">
                    ...
                    <p class="text-xs text-text-muted mt-1">PDF, DOCX, ZIP, MP3, RAR, JPG, PNG...</p>
                  </template>
                  <template v-else>
